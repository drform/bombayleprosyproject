...
// echo "<br>code page";
  ...
  if( query($qry1, 'Person') ) {
    ...
    $qry1_50 = "INSERT INTO `patient` (
      ...
      `patient_code` ,
      `complete_code`
      ) VALUES ($Pid, '$Clinic', $IDclinic, '$Clinic" . "$IDclinic');";
    ...
    if( query($qry5, 'record') ) {
      ...
      $qry6 = "INSERT INTO `treatment_record` (
        ...
        `current_treatment`,
        `present_complaint`
      ) VALUES ($Pid, $Rid, '$Opthalmic_involvement', '$Eyes', '$Assessment', '$Result', '$fcfs', '$omc', '$furtherobservations','$Current_treatment','$follow_up_complaints');";
    ...
    // query("INSERT into image values($Pid,'$Pid',$date)",'image');
