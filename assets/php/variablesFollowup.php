...
$appointment_for = empty($_POST['appointment_for']) ? 'Treatment' : $_POST['appointment_for'];
$appointment_time = empty($_POST['appointment_time'])? 'Not known' : $_POST['appointment_time'];
// $date_for_next_appointment = empty($_POST['date_for_next_appointment']) ? '0000-01-01' : $_POST['date_for_next_appointment'];
if ( empty($_POST['date_of_next_appointment']) ) {
	$date_for_next_appointment = '0000-01-01';
}
else {
	$date_for_next_appointment = $_POST['date_of_next_appointment'];
}
