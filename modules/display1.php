...
<div class="container">
  <table class="table table-bordered">
    <tbody>
      <tr>
        <th colspan="6" id="" style="vertical-align:middle; text-align:center;"><h4><strong>Patient History</strong></h4></th>
        <?php 
        if(mysqli_num_rows($result29)>0){
        while( $row29 = mysqli_fetch_assoc($result29)){ ?>
        <td colspan="1" ><img style="max-width:150px;"src="https://bombayleprosycare.org/assets/images/patient/<?php echo $row29['image_url'] ?>"></td>
        </tr>
        <?php } }else{ ?>
      ...
      <tr>
        <th colspan="1" id="">Examiner</th>
         <?php while( $row26 = mysqli_fetch_assoc($result26)){ ?>
        <td colspan="5"><?php echo $row26['examiner']; ?></td>
        <td colspan="1" style="text-align:left"><strong>Date:</strong><?php echo "  ".$row26['date_attend']; ?></td>
      </tr>
      <?php } ?>
      <tr>
...
<?php while ($row16 = mysqli_fetch_assoc($result16)){ ?>
      <tr>
        <th colspan="">Patient Code:</th>
            <td colspan="6"><?php echo $row16['complete_code']; ?></td>
        <!--<td colspan="6"><?php echo $row16['clinic'].$row16['patient_code']; ?></td>-->
      </tr>
<?php } ?>
      <?php while ($row1 = mysqli_fetch_assoc($result1)){ ?>
      <tr>
        <th colspan="1" id="">Name</th>
        <td colspan="6"><?php echo $row1['fname']; ?></td>
      </tr>
      <tr>
        <th colspan="" id="">Date of Birth</th>
        <td colspan="6"><?php echo $row1['dob']; ?></td>
      </tr>
      <tr>
        <th colspan="" id="">Age</th>
        <td colspan="6"><?php echo $row1['age']; ?></td>
      </tr>
      <tr>
        <th colspan="" id="">Aadhar Number</th>
        <td colspan="6"><?php echo $row1['aadhar']; ?></td>
      </tr>

      <tr>
        <th colspan="" id="">Sex</th>
        <td colspan="6"><?php echo $row1['sex']; ?></td>
      </tr>
      <tr>
        <th colspan="" id="">Caste</th>
        <td colspan="6"> <?php echo $row1['caste']; ?></td>
      </tr>
      <tr>
        <th colspan="" id="">Economical Status</th>
        <td colspan="6"><?php echo $row1['economical_status']; ?></td>
      </tr>
   
   
      <tr>
        <th colspan="" id="">Permanent Address</th>
        <td colspan="6"><?php 
      ...
      <tr>
        <th colspan="" id="">Local Address</th>
        <td colspan="6"><?php 
      ...
      <tr>
        <th colspan=""  id="">Occupation</th>
        <td colspan="6"><?php echo $row1['occupation']; ?></td>
      </tr>
      
      <tr>
        <th colspan="" id="">Referred By</th>
        <td colspan="6"><?php echo $row1['referred']; ?></td>
      </tr>
      ...
      <tr colspan="">
        ...
        <td colspan="2" rowspan ="">Notes: <?php echo $row7['fm_diagnosis']; ?></td>
     </tr>      
     <?php } ?>
      <tr>
        <th colspan="" id="">Allergies</th>
        <td colspan="6"><?php echo $row1['allergy']; } ?></td>
      </tr>
      <tr>
        ...
        <td colspan=" ">Tobacco:</td>
        <td colspan="3">Frequency: <?php echo $row9['addiction_frequency']; ?></td>
      ...
      <tr>
        ...
        <td colspan="6"><?php echo "Disease: " .$row10['disease'] ; }?></td>
 ...
 <?php while( $row11 = mysqli_fetch_assoc($result11)){ ?>
      <tr>
       ...
       <td colspan="2">Drug: <?php echo $row11['drugs']; ?></td>
       <td colspan="">Dosage: <?php echo $row11['dosage']; ?></td>
       <td colspan="">Start Date: <?php echo "  ".$row11['mmyy_start']; ?></td>
       <td colspan="">End Date: <?php echo "  ".$row11['mmyy_end']; ?></td>
      </tr>
     <?php }?>
      <tr>
       <?php while( $row12 = mysqli_fetch_assoc($result12)){ ?>
       <th colspan="" id="">Obstetric History</th>
       <td colspan="6"><?php echo $row12['mmyy_pregnant']; }?></td>
      </tr>
      ...
      <tr>
          ...
          <th colspan="" id="">First Signs and Symptoms(with date of onset) </th>
          <td colspan="6"><?php echo $row17['symptoms']; ?></td>
      </tr>
<?php while( $row17a = mysqli_fetch_assoc($result17a)){ ?>
      <tr>
        <th colspan="1" rowspan="2" id="">Type of Leprosy diagnosed</th>
        <?php if($row17a['pb']==1){?>
...
<?php while( $row22 = mysqli_fetch_assoc($result22)){ ?>
      <tr>
        <th colspan="" id="">Drug Used</th>
        <td colspan="2">Drug Name:<?php echo $row22['dname']; ?></td>
        <td colspan="2">Dosage:<?php echo $row22['dosage']; ?> </td>
        <td colspan="">Start Date:<?php echo $row22['start_date']; ?></td>
        <td colspan="">End Date:<?php echo $row22['end_date']; ?></td>
      </tr>
<?php } ?>
      <tr>
        <th colspan="1" id="">Other MDT courses</th>
        <td colspan="6"><?php echo $row17['other_mdt_courses']; ?></td>
      </tr>

      <tr>
        <?php while( $row17b = mysqli_fetch_assoc($result17b)){ ?>
        <th colspan="1" id="">Outcome after initial treatment</th>
        <td colspan="6"><?php echo $row17b['result']; }?></td>
      </tr>
 <?php while( $row21 = mysqli_fetch_assoc($result21)){ ?>
      <tr>
       
        <th colspan="1" id="">Reaction and treatment</th>
        <td colspan="2">Type of Reaction: <?php echo $row21['type_reaction']; ?></td>
        <td colspan="4">Description: <?php echo $row21['description']; ?></td>
     </tr>
     <?php } ?>
     <tr>
       <th colspan="1"> Current Treatment</th>
       <td colspan="6"><?php echo $row17['current_treatment']; ?></td>
     </tr>
<?php while( $row27 = mysqli_fetch_assoc($result27)){ ?>
      <tr>
        
        <th colspan="1" id="">Disability</th>
        <td colspan="3">Grade: <?php echo $row27['grade']; ?></td>
      ...
      <tr>
        ...
        <th colspan="1" id="">Ophthalmic Involvement</th>
        <td colspan="6"><?php echo $row17c['opthalmic_involvement']; ?></td>
      </tr>
      ...
      <tr>
        <th colspan="1" id="">Assessment Of Skin Lesion</th>
        <td colspan="6"><?php echo $row17c['skin_lesions']; ?></td>
      </tr>
    <?php }?>
    <?php while( $row19 = mysqli_fetch_assoc($result19)){ ?>
      ...
      <tr>
       ...
       <?php while( $row18 = mysqli_fetch_assoc($result18)){ ?>
         <tr>
            <td colspan="1"><?php echo $row18['nerves']; ?></td>
           
            <td colspan="2">Thickened(Left): <?php echo $row18['thickness_left']; ?></td>
            <td colspan="2">Thickened(Right): <?php echo $row18['thickness_right']; ?></td>
            <td colspan="1">Tenderness(Left):<?php echo $row18['tenderness_left']; ?></td>
            <td colspan="1">Tenderness(Right):<?php echo $row18['tenderness_right']; ?></td>
         </tr>
       <?php } ?>
     </tr>

      <tr>
        <th colspan="1" id="">Eyes</th>
        <?php while( $row17d = mysqli_fetch_assoc($result17d)){ ?>
        <td colspan="6"><?php echo $row17d['eyes'];   ?></td>
      </tr>
      <tr>
        <th colspan="1" id="">Present Complaint</th>
        <td colspan="6"><?php echo $row17d['present_complaint'];  } ?></td>
      </tr>
      <tr>
        <th colspan="1">Further Observations</th>
        <td colspan="6"> <?php echo $row17['t_notes']; }?></td>
      </tr>
      <!--<tr>-->
      <!--  <th colspan="7" id="">Images</th>-->
      <!--  <?php  while( $row29 = mysqli_fetch_assoc($result29)){ ?>-->
      <!--<tr>-->
      <!--    <td colspan="7"><img src="https://bombayleprosycare.org/assets/images/patient/<?php echo $row29['image_url'] ?>"><br><?php echo $row29['date'] ?></td>-->
...
<?php } ?>
       ...
       <tr>
          ...
          <td colspan="6">Clinical Notes: <?php echo $row25['clinical_notes']; ?></td>
       </tr> 

<?php 
$result212= mysqli_query($conn,"SELECT * from drugs_prescribed as dp, drugs as d where dp.rid=$fid and dp.did=d.did");
while($row212 = mysqli_fetch_assoc($result212)){?>
    <tr>
        <th colspan="" id="">Drug Used</th>
        <td colspan="3">Drug Name:<?php echo $row212['dname']; ?></td>
        <td colspan="3">Dosage:<?php echo $row212['dosage']; ?> </td>
...
<?php while( $row28 = mysqli_fetch_assoc($result28)){ ?>
       <tr>
        ...
        <th colspan="1" id="">Next Appointment For:</th>
        <td colspan="6"><?php echo $row28['appointment_reason']; ?></td>
      </tr>

       <tr>
        <th colspan="1" id="">Next Appointment Date and Time:</th>
        <td colspan="3"><?php echo $row28['appointment_date']; ?></td>
        <td colspan="3"><?php echo $row28['appointment_time']; ?></td>
      </tr>
<?php } ?>
...
<div class="d-flex justify-content-center">
  <a href="edit_followup.php?pid=<?php echo $id; ?>&fid=<?php echo $fid; ?>" target="_blank" class=""><button type="button" class="btn btn-warning " >Edit Follow Up</button></a><br><br>
</div>
</div>

<?php } ?>
<div class="d-flex justify-content-center">
  <a href="followup.php?pid=<?php echo $id; ?>" target="_blank" class=""><button type="button" class="btn btn-primary " >Fill Followup Form</button></a><br><br>
</div>
</body>