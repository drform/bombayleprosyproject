...
<head>
    ...
    <title>Edit Followup Form</title>
                  ...
                  <div class="form-row" style="padding-left: 34px ;margin-top: 9px;">
                            <div class="form-group" style="padding-left: 34px ;margin-top: 9px;">
                              <label for="DOB" class="form-label">Date</label>
                                <?php 
                                $qry123=mysqli_query($conn,"SELECT DATE(date_attend) AS da from record where rid=$fid and pid=$pid");
                                while($qry12 = mysqli_fetch_assoc($qry123)){ ?>&ensp;&ensp;&ensp;&ensp;
...
$result3 = mysqli_query($conn,"SELECT * from follow_up_record where fid=$fid");
                            ...
                            <textarea name="Cnotes" class="valid" ><?php echo $row3['clinical_notes']; }?></textarea>
                             
                        </div>

                       <div class="form-group">
                          <label for="dp" class="form-label" style=" padding-bottom: 6em;">Drug Prescription</label>
                             <table style="padding-left: 34px ;margin-top: 9px;" id="tb" class="tab orlist">
                                
                                    <tbody>
                                      
                                        <?php 
$result5 = mysqli_query($conn,"SELECT * from drugs_prescribed AS dp, drugs AS d where dp.rid=$fid and d.did=dp.did");
                                        ...
                                        <tr style="padding: 2px;">
                                            ...
                                            <td><a href='javascript:void(0);' style="font-size:18px;" class='remove'><span class='fa fa-minus'></span></a></td>
                                        </tr>
...
$result7 = mysqli_query($conn,"SELECT * from next_appointment where fid=$fid");
                                        ...
                                        <tr>
                                            <td><input type="text" name="appointment_for[]" placeholder="Appointment for..." value="<?php echo $row7['appointment_reason']; ?>"></td>
                                            <td><input style="margin-left: 16px;" type="date" name="date_of_next_appointment[]" value=<?php echo $row7['appointment_date']; ?>></td>
                                            <td><input type="text" name="appointment_time[]" placeholder="Appointment time" value="<?php echo $row7['appointment_time']; ?>"></td>
