...
$result22 = mysqli_query($conn,"SELECT MIN(r.rid),d.dname,dp.dosage,dp.start_date,dp.end_date FROM `record` AS r,drugs AS d,drugs_prescribed AS dp WHERE r.pid=$id and dp.rid=r.rid and dp.did=d.did"); 
...
$result18d = mysqli_query($conn,"SELECT * FROM peripheral_nerves pn, record r, patient p WHERE p.pid=$id AND p.pid=r.pid and pn.rid=r.rid AND pn.nerves = 'Median Cutaneous'");
...
$result18i = mysqli_query($conn,"SELECT * FROM peripheral_nerves pn, record r, patient p WHERE p.pid=$id AND p.pid=r.pid and pn.rid=r.rid AND pn.nerves = 'Superficial Peroneal'");
...
<body>
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <form method="POST" id="signup-form" class="signup-form" action="../assets/php/update.php?pid=<?php echo $id; ?>&rid=<?php echo $pid; ?>" enctype="multipart/form-data">
                <h3>
                ...
                <fieldset>
                    <div class="form-row" style="padding-left: 34px ;margin-top: 9px;">
                            <div class="form-group" style="padding-left: 34px ;margin-top: 9px;">
                                ...
                                <?php 
                                $qry123=mysqli_query($conn,"SELECT DATE(date_attend) AS da from record as r, patient as p where p.pid = $id and r.pid = p.pid LIMIT 1");
                                while($qry12 = mysqli_fetch_assoc($qry123)){ ?>
                                <input style="margin-left: 13px;" type="date" name="formDate" id="formDate" value=<?php echo $qry12['da'];}?> />
                            </div>
                </div>
                    <div class="fieldset-content">
                       ...
                       <div class="clear"></div>
                            ...
                            <div class="form-textarea" id="ObstetricHDiv">              
                                    ...
                                    <?php if(mysqli_num_rows($result12)>0){while( $row12 = mysqli_fetch_assoc($result12)){ ?>
                                    ...
                                    <?php }else{ ?>
                                        <td><input type="text" id="ObstetricH" name="ObstetricH" placeholder="Obstetric History" class="valid" value="" ></td>
                                    <?php } ?>
                            </div>
                        ...
                        <div class="form-row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <table style="padding-left: 34px ;margin-top: 9px;" id="tb7" class="form-label">
                                    <tbody>
                                         <?php while($row4 = mysqli_fetch_assoc($result4)){ ?>
                                        <tr class="tr-header">
                                            <th><input type="number" name="Contact[]" id="Contact[]" value=<?php echo $row4['mobile'];  ?> /></th>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group"  >
                               ...
                               <?php
                               $reff1 = mysqli_query($conn,"SELECT * from person where pid = $id");
                                 while( $row241 = mysqli_fetch_assoc($reff1)){ ?>
                                <input type="text" name="Referred" id="Referred" value="<?php echo $row241['referred'];?>" />
                                <?php } ?>
                            </div>
                        </div>
                    ...
                    <div class="fieldset-content">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody style="text-align:center">
                              ...
                              <tr> 
                                ...
                                <?php if($row18a['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Supra_orbital_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Supra_orbital_Thicken_Left" value="Yes"></td>
                                <?php } if($row18a['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Supra_orbital_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Supra_orbital_Thicken_Right" value="Yes"></td>
                                <?php } if($row18a['tenderness_left']==='Yes') { ?>
                                <td colspan="1" align="center"><input type="checkbox" name="Supra_orbital_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Supra_orbital_Tender_Left" value="Yes"></td>
                                <?php } if($row18a['tenderness_right']==='Yes') { ?>
                                <td colspan="1" align="center"><input type="checkbox" name="Supra_orbital_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                              ...
                              <tr>
                                ...
                                <?php if($row18b['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Great_Auricular_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Great_Auricular_Thicken_Left" value="Yes"></td>
                                <?php } if($row18b['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Great_Auricular_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Great_Auricular_Thicken_Right" value="Yes"></td>
                                <?php } if ($row18b['tenderness_left']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Great_Auricular_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Great_Auricular_Tender_Left" value="Yes"></td>
                                <?php } if ($row18b['tenderness_right']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Great_Auricular_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                              ...
                              <tr>
                                ...
                                <td>Ulnar</td>
                                <?php if( $row18c['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Ulnar_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Ulnar_Thicken_Left" value="Yes"></td>
                                <?php } if( $row18c['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Ulnar_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Ulnar_Thicken_Right" value="Yes"></td>
                                <?php } if ($row18c['tenderness_left']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Ulnar_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Ulnar_Tender_Left" value="Yes"></td>
                                <?php } if ($row18c['tenderness_right']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Ulnar_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                             ...
                             <tr>
                                ...
                                <?php if($row18d['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Median_Cutaneous_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Median_Cutaneous_Thicken_Left" value="Yes"></td>
                                <?php } if($row18d['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Median_Cutaneous_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Median_Cutaneous_Thicken_Right" value="Yes"></td>
                                <?php } if ($row18d['tenderness_left']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Median_Cutaneous_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Median_Cutaneous_Tender_Left" value="Yes"></td>
                                <?php } if ($row18d['tenderness_right']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Median_Cutaneous_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                            ...
                            <tr> 
                                ...
                                <?php if($row18e['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Radial_Cutaneous_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>>
                                <td colspan="1" align="center"><input type="checkbox" name="Radial_Cutaneous_Thicken_Left" value="Yes"></td>
                                <?php } if($row18e['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Radial_Cutaneous_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Radial_Cutaneous_Thicken_Right" value="Yes"></td>
                                <?php } if ($row18e['tenderness_left']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Radial_Cutaneous_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Radial_Cutaneous_Tender_Left" value="Yes"></td>
                                <?php } if ($row18e['tenderness_right']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Radial_Cutaneous_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                            ...
                            <tr>
                                ...
                                <?php if($row18f['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Lateral_Popliteal_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Lateral_Popliteal_Thicken_Left" value="Yes"></td>
                                <?php } if($row18f['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Lateral_Popliteal_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Lateral_Popliteal_Thicken_Right" value="Yes"></td>
                                <?php } if($row18f['tenderness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Lateral_Popliteal_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Lateral_Popliteal_Tender_Left" value="Yes"></td>
                                <?php } if($row18f['tenderness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Lateral_Popliteal_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                            ...
                            <tr>
                                ...
                                <td>Sural Nerve</td>
                                <?php if($row18g['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Sural_Nerve_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Sural_Nerve_Thicken_Left" value="Yes"></td>
                                <?php } if($row18g['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Sural_Nerve_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Sural_Nerve_Thicken_Right" value="Yes"></td>
                                <?php } if ($row18g['tenderness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Sural_Nerve_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else{?>
                                <td colspan="1" align="center"><input type="checkbox" name="Sural_Nerve_Tender_Left" value="Yes"></td>
                                <?php } if ($row18g['tenderness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Sural_Nerve_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else{?>
                            ...
                            <tr>
                                ...
                                <?php if($row18h['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Posterior_Tibial_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Posterior_Tibial_Thicken_Left" value="Yes"></td>
                                <?php } if($row18h['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Posterior_Tibial_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Posterior_Tibial_Thicken_Right" value="Yes"></td>
                                <?php } if ($row18h['tenderness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Posterior_Tibial_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Posterior_Tibial_Tender_Left" value="Yes"></td>
                                <?php } if ($row18h['tenderness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Posterior_Tibial_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                            ...
                            <tr>
                                ...
                                <?php if($row18i['thickness_left']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Superficial_Peroneal_Thicken_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Superficial_Peroneal_Thicken_Left" value="Yes"></td>
                                <?php } if($row18i['thickness_right']==='Yes'){?>
                                <td colspan="1" align="center"><input type="checkbox" name="Superficial_Peroneal_Thicken_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Superficial_Peroneal_Thicken_Right" value="Yes"></td>
                                <?php } if ( $row18i['tenderness_left']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Superficial_Peroneal_Tender_Left" value="Yes" checked="checked"></td>
                                <?php } else {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Superficial_Peroneal_Tender_Left" value="Yes"></td>
                                <?php } if ( $row18i['tenderness_right']==='Yes') {?>
                                <td colspan="1" align="center"><input type="checkbox" name="Superficial_Peroneal_Tender_Right" value="Yes" checked="checked"></td>
                                <?php } else {?>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-textarea">
                            ...
                            <textarea name="Complaint" id="Complaint" placeholder=""  ><?php echo $row17d['present_complaint']; ?></textarea>
                        </div>
                         ...
                         <div class="form-textarea">
                            ...
                            <div class="form-label">
                                Upload Images:
                                <?php 
                                // $qry = "seelct * from images where pid=$id";
                                // while($row = mysqli_fetch_assoc(mysqli_query($conn,$qry1))){
