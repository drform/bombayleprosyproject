                ...
                <fieldset>
                    <div class="form-row" style="padding-left: 34px ;margin-top: 9px;">
                            <div class="form-group" style="padding-left: 34px ;margin-top: 9px;">
                                <label for="DOB" class="form-label">Date</label>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                                <input style="margin-left: 13px;" type="date" name="formDate" id="formDate" value=<?php echo date("Y-m-d"); ?> />
                            </div>
							<div class="staff">
							<div class="form-group">
                            <label for="staffname" class="form-label">Staff Name</label>
                            <input type="text" name="staffname" id="staffn" placeholder="Staff Name"/>
							</div>
                        </div>
                                    ...
                                    <table>
                                     <tr >
                                        <td><input type="text" name="Tobacco" class="valid" placeholder="Frequency"></td>
                                            <td><input style="margin-left: 16px;width: 265px;" type="text" name="Tobacco_notes" class="valid" placeholder="Notes"></td> 
                                    ...
                                    <table>
                                       <tr>
                                        <td><input type="text" name="Cigarette" class="valid" placeholder="Frequency"></td>
                                            <td><input style="margin-left: 16px;width: 265px;" type="text" name="Cigarette_notes" class="valid" placeholder="Notes"></td>                                         
                                     </tr>
                                    </table>
                                   ...
                                   <label>Alcohol (ml/day) </label> 
                                    <table>
                                        <tr>
                                            ...
                                            <td><input style="margin-left: 16px;width: 265px;" type="text" name="Alcohol_notes" class="valid" placeholder="Notes"></td> 
                                     </tr>   
                                    </table></br\>
                                    </div>
                            </div></div>
